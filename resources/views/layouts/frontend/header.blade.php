    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('frontend') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        {{-- <img src="{{ URL::asset('build/images/logo-sm-dark.png') }}" alt="logo-sm-dark"
                            height="24"> --}}
                            DL
                    </span>
                    <span class="logo-lg">
                ...
                <a href="{{ route('frontend') }}" class="logo logo-light">
                    <span class="logo-sm">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                @guest
                    <button onclick="window.location.href='{{ route('login') }}'" class="btn header-item waves-effect" id="page-header-user-dropdown">LOGIN</button>
                @else
