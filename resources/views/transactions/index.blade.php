                        ...
                        <tbody>
                            @foreach ($orders as $key => $order)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('transactions.detail',['order_code' => $order->order_code, 'order_reference' => $order->order_reference]) }}" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
